...
def get_authenticated_service(args, selenium_driver):
    try:
        breakpoint()
        ...
        breakpoint()
        build_return_value = build(YOUTUBE_API_SERVICE_NAME,
                                   YOUTUBE_API_VERSION,
        ...
        print("Exception occurred in youtube_api - get_authenticated_service() :", exp)
        breakpoint()
...
def youtube_upload_api(file,
    ...
    youtube = get_authenticated_service(args, selenium_driver)
    try:
